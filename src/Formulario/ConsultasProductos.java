...
public class ConsultasProductos extends javax.swing.JInternalFrame {
    ...
    void mostrartodosproductos()
    {
        ...
        String []titulos={"Orden","Descripcion","Categoria","Unidad","Cantidad","Precio1","Precio2","Stock"};
        tabla.setColumnIdentifiers(titulos);
        this.tbproductos.setModel(tabla);
        String consulta= "SELECT * FROM productoma";
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(rbtndes)
                    .addComponent(txtdes, javax.swing.GroupLayout.PREFERRED_SIZE, 23, javax.swing.GroupLayout.PREFERRED_SIZE)
...
// TODO add your handling code here:
    ...
    if(rbtndes.isSelected()==true)
    {
        ...
        tabla.setColumnIdentifiers(titulos);
        this.tbproductos.setModel(tabla);
        String consulta= "SELECT * FROM productoma WHERE descripcion  LIKE '%"+buscar+"%'";
        String []Registro= new String [8];
        try {
            Statement st = cn.createStatement();
            ResultSet rs= st.executeQuery(consulta);
