...
public class ConsultasClientes extends javax.swing.JInternalFrame {
    ...
    private void initComponents() {
        ...
        rddni.setText("Buscar Clientes por Dir:");
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addComponent(txtnom, javax.swing.GroupLayout.DEFAULT_SIZE, 358, Short.MAX_VALUE))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addComponent(rdtodo)
...
// TODO add your handling code here:
   ...
   if(rdgenero.isSelected()==true)
   {
       ...
       try {
            ...
            String ConsultaSQL="SELECT * FROM clientes WHERE nom_cli='"+nom+"'";
   ...
   if(rddni.isSelected()==true)
   {
       ...
       try {
            ...
            String ConsultaSQL="SELECT * FROM clientes WHERE dir_cli='"+dni+"'";
