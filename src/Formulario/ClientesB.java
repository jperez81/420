...
public class ClientesB extends javax.swing.JInternalFrame {
    ...
    void mostrarclientes(String valor) {
        ...
        try {
            ...
            Logger.getLogger(ClientesB.class.getName()).log(Level.SEVERE, null, ex);
        }
   ...
   String cod = "", nom = "", ape = "", dir = "", ent = "",tel ="", tipo = "";
    ...
    try {
        if (fila == -1) {
            ...
            Boleta.txtcod.setDisabledTextColor(Color.blue);
            Boleta.txtcod.setText(cod);
            Boleta.txtnomape.setDisabledTextColor(Color.blue);
            Boleta.txtnomape.setText(nom + "   " + ape);
            Boleta.txtdir.setDisabledTextColor(Color.blue);
            Boleta.txtdir.setText(dir);
            Boleta.txtentre.setDisabledTextColor(Color.blue);
            Boleta.txtentre.setText(ent);
            Boleta.txttel.setDisabledTextColor(Color.blue);
            Boleta.txttel.setText(tel);
            Boleta.txttipo.setDisabledTextColor(Color.blue);
            Boleta.txttipo.setText(tipo);
