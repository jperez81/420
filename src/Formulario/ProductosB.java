...
DefaultTableModel tabla;
      ...
      String comparar(String orden)
    {
     ...
     void cargarlistaproductos(String dato){
         if(Boleta.txttipo.getText().equals("Mesa")){
             
        String [] Titulo = {"Orden","Descripcion","Categoria","Unidad Medida","Cantidad","Precio","Stock"};
        tabla=new DefaultTableModel(null,Titulo);
    String []Registro= new String[7];
    String mostrar="SELECT * FROM productoma WHERE CONCAT (orden,'',descripcion) LIKE '%"+dato+"%'"; 
    Statement st;
        try {
...
//                Registro[6]=rs.getString("precio2");
         ...
         if(Boleta.txttipo.getText().equals("Envio")){
      
            String [] Titulo = {"Orden","Descripcion","Categoria","Unidad","Cantidad","Precio","Stock"};
        tabla=new DefaultTableModel(null,Titulo);
    String []Registro= new String[7];
    String mostrar="SELECT * FROM productoma WHERE CONCAT (orden,'',descripcion) LIKE '%"+dato+"%'"; 
    Statement st;
